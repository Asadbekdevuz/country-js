...
for (let count of countrys) {
  ...
  let elPopulationtext = document.createElement("p")
  let elPopulationtext1 = document.createElement("p")
  let elImg = document.createElement("img");
  elItem.setAttribute("class", "bg-white mb-4 shadow rounded ")
  ...
  elText.textContent = count.name;
  elItem.prepend(elImg);

  elItem.appendChild(elPopulation);
  elPopulation.textContent = `Population: ${count.population}`;
  
  elItem.appendChild(elPopulationtext);
  elPopulationtext.textContent = `Region:${count.region}`

  elItem.appendChild(elPopulationtext1);
  elPopulationtext1.textContent = `Region:${count.capital}`
